...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>View/Edit Trip</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="requesterList.php">Trips</a></li>
                        <li class="breadcrumb-item active">Add or Update Items</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
				...
				foreach($items as $i){
				    ...
				    print'<form action="updateItem.php" id="'.$rowFormName.'" method="post"/></form>';
				    print '<tr>';
                                    print'<td class="quantity-box">';
				    print'<input id="'.$itemIDName.'" type="hidden" name="itemIDName" form="'.$rowFormName.'" value="'.$i['ITEMID'].'"/>';
				    print'<input id="'.$prodName.'" type="text" class="c-input-text qty text" name="prodName" form="'.$rowFormName.'" value="'.$i['PRODUCT'].'"/>';
				    print'</form></td>';
                                    print'<td class="quantity-box"><input id="'.$quantityName.'" type="number" class="c-input-text qty text" name="qty" form="'.$rowFormName.'" value="'.$i['QTY'].'"/></td>';
				...
				<form action="addItem.php" id="addItemForm" method="post"/></form>
				<tr>
				<td class="quantity-box">
				<input id="addProdName" type="text" class="c-input-text qty text" name="addProdName" form="addItemForm"/>
				</td>
				<td class="quantity-box">
				<input id="addQty" type="qty" class="c-input-text qty text" name="addQty" form="addItemForm"/>
				</td>
				<td class="remove-pr">
				<div class="update-box">
				<input class="button" type="submit" form="addItemForm" value="Add"/>
				</div>
				</td>
				</tr>
			  </tbody>
