...
<body>
    ...
    <div class="all-title-box">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>Make/Manage Trips</h2>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Trips</a></li>
                        <li class="breadcrumb-item active">Make/Manage Trips</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="cart-box-main">
        <div class="container">
            <div class="row">
				...
				$uid = $_SESSION['uid'];
				$stmt = oci_parse($conn, 'begin :cursor := getBuyerTrips(:uid);end;'); 
				...
				foreach($cursor as $t) {
				    ...
				    print'</td>';
				    print'<td class="name-pr">';
					print'<form action="tripItemsBuyer.php" method="POST">';
				...
				?>
				<tr> <form id="newTripInfo" action="addTrip.php" method="POST"/></form>
					<td><input type="text" name="Date" form="newTripInfo" required/></td>
					<td><input type="text" name="Store" form="newTripInfo" required/></td>
					<td></td>
					<td class "remove-pr">
						<div class = "update-box">
						<input type="submit" class="button" form="newTripInfo" value="Add Trip" href="addTrip.php"/>
						</div>	
					</td>
				</tr>
                            </tbody>
